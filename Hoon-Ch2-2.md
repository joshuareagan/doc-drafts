...
To see other irregular expressions, check the irregular expression reference document (link).
...
A *running* body doesn't have a fixed number of subexpressions; hoons with running bodies can be arbitrarily long.
